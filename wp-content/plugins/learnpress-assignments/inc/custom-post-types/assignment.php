...
if ( ! class_exists( 'LP_Assignment_Post_Type' ) ) {
	...
	final class LP_Assignment_Post_Type extends LP_Abstract_Post_Type {
		...
		public function assignment_meta_boxes() {
			...
			add_meta_box( 'assignment_attachments', esc_html__( 'Documentations', 'learnpress-assignments' ), 'LP_Assignment_Meta_Box_Document::output', LP_ASSIGNMENT_CPT, 'normal', 'high' );
			add_meta_box( 'assignment_settings', esc_html__( 'General Settings', 'learnpress-assignments' ), 'LP_Assignment_Meta_Box_Settings::output', LP_ASSIGNMENT_CPT, 'normal', 'high' );
		}
