...
$last_answer    = $assigment_db->get_extra_value( $current_useritem_id, $assigment_db::$answer_note_key);
		...
		<div class="learn-press-assignment-uploaded">
			<ul class="assignment-files assignment-uploaded list-group list-group-flush">
				<?php foreach ( $uploaded_files as $file ) : ?>
					<li class="list-group-item"><a href="<?php echo esc_url( get_site_url() . $file->url ); ?>" target="_blank"><?php echo $file->filename; ?></a></li>
				<?php endforeach; ?>
			</ul>
		</div>
	<?php endif; ?>
