...
new Vue({
  ...
  data: {
    ...
    wizard: {
      ...
      disable_instructor_premoderation: false,
  ...
  methods: {
    ...
    acceptSettings: function acceptSettings() {
      this.$http.post("".concat(this.ajax_url, "?action=stm_lms_wizard_save_settings"), this.wizard, function () {});
    },
    ...
    saveBusinessType: function saveBusinessType() {
      ...
      this.$http.post("".concat(this.ajax_url, "?action=stm_lms_wizard_save_business_type"), this.business_type, function () {});
      /*Save analytics*/
