	...
	<div id="stm_lms_statistics" class="stm-lms-postbox-container">
		...
		<div class="metabox-holder">
			...
			<div class="postbox-container">
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox ">
						<h2 class="hndle"><span><span> <?php esc_html_e("Instructors Earnings", "masterstudy-lms-learning-management-system")?></span></h2>
						<div class="inside">
							<div class="main">
					...
					<div class="postbox ">
						...
						<div class="inside">
							<div class="main">
								...
								<span> <?php esc_html_e("Admin commission", "masterstudy-lms-learning-management-system")?> : <?php echo  esc_attr($author_fee)?>% </span>
							</div>
						</div>
					</div>
				</div>
