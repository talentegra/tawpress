    ...
    return array(
        ...
        'fields' => array(
            ...
            'enable_courses_filter_notice' => array(
                ...
                'type' => 'notice',
                'label' => esc_html__('Search Filters', 'masterstudy-lms-learning-management-system'),
                'description' => esc_html__('With enabled filters, default courses per row will be 3 with adaptive settings for best look.', 'masterstudy-lms-learning-management-system'),
                'columns' => '1',
            ),
