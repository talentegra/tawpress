...
<div id="stm_lms_user_manage" class="lms-dashboard-table">
    ...
    <table>
        ...
        <tr>
            ...
            <th><?php esc_html_e( 'Degree', 'masterstudy-lms-learning-management-system' ); ?></th>
            <th><?php esc_html_e( 'Expertise', 'masterstudy-lms-learning-management-system' ); ?></th>
        ...
        <tbody>
            <tr v-for="(user, key) in computedUsers">
                ...
                <td v-html="user.degree"></td>
                <td v-html="user.expertize"></td>
