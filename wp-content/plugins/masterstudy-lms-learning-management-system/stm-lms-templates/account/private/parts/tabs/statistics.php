...
<div id="stm-account-statistics" v-bind:class="{'min-height-500': order_items.length}">
    ...
    <button v-if="!order_items.length" @click="date_range = null" class="btn btn-default"><?php esc_html_e('Clear Filter', 'masterstudy-lms-learning-management-system'); ?></button>
