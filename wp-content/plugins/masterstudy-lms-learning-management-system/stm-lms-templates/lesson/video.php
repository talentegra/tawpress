...
if(!empty($lesson_video_poster) and !empty($lesson_video_url)): ?>
    <div class="stm_lms_video stm_lms_video__iframe" style="background: url('<?php echo esc_url(stm_lms_get_image_url($lesson_video_poster, 'full')); ?>');">
        <i class="stm_lms_play"></i>
        <iframe data-src="<?php echo esc_url($lesson_video_url); ?>" allowfullscreen webkitallowfullscreen mozallowfullscreen></iframe>
    </div>
<?php endif;
