...
<div class="wrap">
	...
	<h2><?php _e( 'Post Category Image With Grid and Slider - Features', 'post-category-image-with-grid-and-slider' ); ?></h2><br />
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Post Category Image With Grid and Slider</strong> included in <br /><strong>Essential Plugin Bundle</strong></p>
