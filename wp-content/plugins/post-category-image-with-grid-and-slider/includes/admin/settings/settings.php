...
<div class="wrap pciwgas-settings">
	<h2><?php _e( 'Post Category Image Grid and Slider - Settings', 'post-category-image-with-grid-and-slider' ); ?></h2>
	<?php
			...
			<div class="meta-box-sortables">
				<div id="general" class="postbox">
					...
					<div class="postbox-header">
						<h3 class="hndle">
							<span><?php _e( 'Taxonomy Settings', 'post-category-image-with-grid-and-slider' ); ?></span>
						</h3>
					</div>
					...
					<div class="inside">
						...
						<table class="form-table pciwgas-design-settings-tbl">
							<tbody>
								<tr>
									<th scope="row">
										<label for="pciwgas-enable-author"><?php _e('Taxonomy', 'post-category-image-with-grid-and-slider'); ?>:</label>
									</th>
									<td>
										<?php
										 $args = array(
											...
											<?php }
										?>
										<span class="description"><?php _e('Select taxonomy box to enable support. Custom settings on category listing page will be enabled for selected categories.', 'post-category-image-with-grid-and-slider'); ?></span>
									</td>
								</tr>
								<tr>
									<td colspan="2" scope="row">
										<input type="submit" name="pciwgas_settings_submit" class="button button-primary right pciwgas-settings-submit" value="<?php _e('Save Changes','post-category-image-with-grid-and-slider');?>" />
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="inside">
						...
						<table class="form-table pciwgas-design-settings-tbl">
							<tbody>
								<tr>
									<th scope="row">
										<label for="pciwgas-enable-author"><?php _e('Use the shortcode', 'post-category-image-with-grid-and-slider'); ?>:</label>
									</th>
									<td>
										<p>1. <?php _e('Display categories in grid view', 'post-category-image-with-grid-and-slider'); ?><br />
										...
										<p>2. <?php _e('Display categories in slider view', 'post-category-image-with-grid-and-slider'); ?><br />
