...
function pciwgas_register_guten_block() {
	...
	// Block Editor Script
	wp_register_script( 'pciwgas-block-js', PCIWGAS_URL.'assets/js/blocks.build.js', array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'wp-components' ), PCIWGAS_VERSION, true );
	wp_localize_script( 'pciwgas-block-js', 'Pciwgas_Block', array(
																'pro_demo_link'		=> 'https://demo.wponlinesupport.com/prodemo/post-category-image-with-grid-and-slider-demo/',
																'free_demo_link'	=> 'https://demo.wponlinesupport.com/post-category-image-with-grid-and-slider-demo/#check-free-demo-wr',
																'pro_link'			=> PCIWGAS_PLUGIN_LINK,
															));
