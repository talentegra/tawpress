...
?>
<div class="rtec-form-wrapper rtec-toggle-on-click<?php echo $form_styles['form_class_att']; ?>" data-remaining="<?php echo $max_guests; ?>" style="<?php echo $form_styles['form_style_att']; ?>">
	...
	<form method="post" action="" id="rtec-form" class="rtec-form">
		...
		<div class="rtec-form-buttons">
			<input type="submit" class="rtec-submit-button<?php echo $form_styles['button_class_att']; ?><?php echo $submit_button_class; ?>" name="rtec_submit" value="<?php echo esc_attr( $submit_button_text ); ?>" style="<?php echo $form_styles['button_style_att']; ?>"/>
		</div>
