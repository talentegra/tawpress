    ...
    function prefetch_urls() {
        ...
        if( $this->main_instance->get_single_config("cf_prefetch_urls_viewport", 0) > 0 ): ?>
            ...
            <script id="swcfpc" data-cfasync="false">
                ...
                var swcfpc_prefetch_urls_timestamp_server = '<?php echo $this->main_instance->get_single_config("cf_prefetch_urls_viewport_timestamp", time()); ?>';

                var swcfpc_prefetched_urls = localStorage.getItem("swcfpc_prefetched_urls");
                swcfpc_prefetched_urls = (swcfpc_prefetched_urls) ? JSON.parse(swcfpc_prefetched_urls) : [];

                var swcfpc_prefetch_urls_timestamp_client = localStorage.getItem("swcfpc_prefetch_urls_timestamp_client");
