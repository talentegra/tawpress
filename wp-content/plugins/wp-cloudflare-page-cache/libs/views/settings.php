                ...
                <div class="swcfpc_tab <?php if($tab_active == "other") echo 'active'; ?>" id="other">
                    ...
                    <div class="main_section">
                        ...
                        <div class="right_column">
                            ...
                            <br/>
                            <div class="description highlighted"><?php _e('URIs in <i>Prevent the following URIs to be cached</i> will not be prefetched.', 'wp-cloudflare-page-cache'); ?></div>
                            <br/>
                        </div>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="swcfpc_tab <?php if($tab_active == "faq") echo 'active'; ?>" id="faq">
                    ...
                    <div class="swcfpc_faq_accordion">
                        ...
                        <div class="swcfpc_faq_answer">
                            ...
                            <p><?php _e('If the <b>Purge HTML pages only</b> option is enabled, clicking on the <b>PURGE CACHE</b> button only HTML pages already in cache will be deleted from Cloudflare\'s cache.', 'wp-cloudflare-page-cache'); ?></p>

                            <p><?php _e('If for some reason you need to delete static files (such as CSS, images and scripts) from Cloudflare\'s cache, you can do so by clicking on <b>Force purge everything</b>', 'wp-cloudflare-page-cache'); ?></p>
