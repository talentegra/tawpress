...
if( !class_exists('SW_CLOUDFLARE_PAGECACHE') ) {
    ...
    class SW_CLOUDFLARE_PAGECACHE {
        ...
        function get_default_config() {
            ...
            // Pages
            $config["cf_excluded_urls"]                 = array("/*ao_noptirocket*", "/*jetpack=comms*", "/*kinsta-monitor*", "*ao_speedup_cachebuster*", "/*removed_item*");
            ...
            $config["keep_settings_on_deactivation"] = 0;
        ...
        function deactivate_plugin() {
            ...
            if( $this->get_single_config("keep_settings_on_deactivation", 0) > 0 )
