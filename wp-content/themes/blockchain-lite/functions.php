...
function blockchain_lite_archive_layout_choices() {
	...
	$text = _n_noop( '%d column', '%d columns', 'blockchain-lite' );

	return apply_filters( 'blockchain_lite_archive_layout_choices', array(
		1 => sprintf( translate_nooped_plural( $text, 1, 'blockchain-lite' ), number_format_i18n( 1 ) ),
		2 => sprintf( translate_nooped_plural( $text, 2, 'blockchain-lite' ), number_format_i18n( 2 ) ),
		3 => sprintf( translate_nooped_plural( $text, 3, 'blockchain-lite' ), number_format_i18n( 3 ) ),
	) );
}
...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Arimacourses', 'Post Type General Name', 'twentytwenty' ),
        'singular_name'       => _x( 'Arimacourse', 'Post Type Singular Name', 'twentytwenty' ),
        'menu_name'           => __( 'Arimacourses', 'twentytwenty' ),
        'parent_item_colon'   => __( 'Parent Arimacourse', 'twentytwenty' ),
        'all_items'           => __( 'All Arimacourses', 'twentytwenty' ),
        'view_item'           => __( 'View Arimacourse', 'twentytwenty' ),
        'add_new_item'        => __( 'Add New Arimacourse', 'twentytwenty' ),
        'add_new'             => __( 'Add New', 'twentytwenty' ),
        'edit_item'           => __( 'Edit Arimacourse', 'twentytwenty' ),
        'update_item'         => __( 'Update Arimacourse', 'twentytwenty' ),
        'search_items'        => __( 'Search Arimacourse', 'twentytwenty' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        'label'               => __( 'arimacourses', 'twentytwenty' ),
        'description'         => __( 'Arimacourse news and reviews', 'twentytwenty' ),
        'labels'              => $labels,
    ...
    register_post_type( 'arimacourses', $args );
...
add_action('init', 'cw_post_type_course');
