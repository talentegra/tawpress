...
function blockchain_lite_customize_preview_js() {
	wp_enqueue_script( 'blockchain-lite-customizer-preview', get_template_directory_uri() . '/js/admin/customizer-preview.js', array( 'customize-preview' ), blockchain_lite_asset_version(), true );
	wp_enqueue_style( 'blockchain-lite-customizer-preview', get_template_directory_uri() . '/css/admin/customizer-preview.css', array( 'customize-preview' ), blockchain_lite_asset_version() );
}
...
function blockchain_lite_customize_controls_js() {
	...
	wp_enqueue_script( 'blockchain-lite-customizer-section-pro', get_template_directory_uri() . '/inc/customizer-controls/section-pro/customize-controls.js', array( 'customize-controls' ), blockchain_lite_asset_version(), true );
	wp_enqueue_style( 'blockchain-lite-customizer-section-pro', get_template_directory_uri() . '/inc/customizer-controls/section-pro/customize-controls.css', array(), blockchain_lite_asset_version() );

	wp_enqueue_script( 'blockchain-lite-customizer-controls', get_template_directory_uri() . '/js/admin/customizer-controls.js', array(), blockchain_lite_asset_version(), true );
