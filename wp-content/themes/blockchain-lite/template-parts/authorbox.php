<div class="entry-author-box">
	<figure class="entry-author-thumbnail">
		<?php $avatar_size = apply_filters( 'blockchain_lite_the_post_author_box_avatar_size', 200 ); ?>
	...
	<div class="entry-author-desc">
		...
		<?php if ( get_the_author_meta( 'description' ) ) {
			echo wp_kses( get_the_author_meta( 'description' ), blockchain_lite_get_allowed_tags() );
		} ?>
	</div>
</div>
