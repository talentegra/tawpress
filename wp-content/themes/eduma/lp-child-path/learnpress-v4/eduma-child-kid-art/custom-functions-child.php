	...
	function kid_art_child_eduma_add_custom_field_course() {
		lp_meta_box_text_input_field(
			array(
				...
				'description' => esc_html__( 'Display duration info', 'eduma-child-kid-art' ),
				'default'     => esc_html__( '30 hours', 'eduma-child-kid-art' ),
			)
		);
		lp_meta_box_text_input_field(
			array(
		...
		lp_meta_box_text_input_field(
			array(
				...
				'label'   => esc_html__( 'Skill Levels', 'eduma-child-kid-art' ),
				'desc'    => esc_html__( 'Display skill levels', 'eduma-child-kid-art' ),
				'default' => esc_html__( 'All level', 'eduma-child-kid-art' )
			)
		);
