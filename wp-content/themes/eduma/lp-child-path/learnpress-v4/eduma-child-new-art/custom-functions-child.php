	...
	function kid_new_art_child_eduma_add_custom_field_course() {
		...
		lp_meta_box_text_input_field(
			array(
				...
				'id'          => 'thim_course_time',
				'description' => esc_html__( 'Show Time start and time end in course', 'eduma-child' ),
				'default'     => '',
			)
		);
		lp_meta_box_text_input_field(
			array(
				...
				'description' => esc_html__( 'Show Day of Week Course', 'eduma-child' ),
				'default'     => '',
			)
		);
		...
		lp_meta_box_text_input_field(
			array(
				...
				'label'   => esc_html__( 'Skill Levels', 'eduma-child' ),
				'desc'    => esc_html__( 'Display skill levels', 'eduma-child' ),
				'default' => esc_html__( 'All level', 'eduma-child' )
			)
		);
...
add_action(
	...
	$skill_levels    = ! empty( $_POST['thim_course_skill_levels'] ) ? $_POST['thim_course_skill_levels'] : '';
	...
	update_post_meta( $post_id, 'thim_course_skill_levels', $skill_levels );
